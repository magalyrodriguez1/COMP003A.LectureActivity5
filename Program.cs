 ...
 * Purpose: XML comments and C# methods
 * Course: COMP-003A
*/
...
namespace COMP003A.LectureActivity5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            HelloWorld("Alan Turing", DateTime.Now.Year - 1912); //call to HelloWWorld (string name, int inputAge) which is an overloaded method
            HelloWorld("Ada Lovelace", DateTime.Now.Year - 1815); //call to HelloWorld (string name, int inputAge) again
            HelloWorld("Charles Babbage", DateTime.Now.Year - 1791); //call to HelloWorld(string name, int inputAge) afgain
         ...
         * if you type '///' on top of a class or method, visual studio will 
         * populate the structure for you otherwise you would have to use the following
         * opening AND closing tags similar to most html elements.
         * <summary></summary> used to descrive a type member
         * <param name="nameOfTheParameter"</param> used for describing one or more parameters in the method
         * signature
